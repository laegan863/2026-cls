                ...
                <form action="{{ route('admin.permit-types.update', $permitType) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <x-input name="short_name" placeholder="Enter short name (optional)" value="{{ old('short_name', $permitType->short_name) }}" />
                            @error('short_name')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <x-textarea name="description" rows="3" placeholder="Enter description (visible to client)" value="{{ old('description', $permitType->description) }}" required />
                        @error('description')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                ...
                                <x-select name="jurisdiction_level" id="jurisdiction_level">
                                    ...
                                    <option value="city" {{ old('jurisdiction_level', $permitType->jurisdiction_level) == 'city' ? 'selected' : '' }}>City</option>
                                    <option value="county" {{ old('jurisdiction_level', $permitType->jurisdiction_level) == 'county' ? 'selected' : '' }}>County</option>
                                    <option value="state" {{ old('jurisdiction_level', $permitType->jurisdiction_level) == 'state' ? 'selected' : '' }}>State</option>
                                    <option value="federal" {{ old('jurisdiction_level', $permitType->jurisdiction_level) == 'federal' ? 'selected' : '' }}>Federal</option>
                                </x-select>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <x-select name="agency_name">
                                    ...
                                    @forelse ($agencies as $agency)
                                        <option value="{{ $agency->name }}" {{ old('agency_name', $permitType->agency_name) == $agency->name ? 'selected' : '' }}>{{ $agency->name }}</option>
                                    @empty
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            <x-toggle name="has_renewal" label="Enable Renewal?" :checked="old('has_renewal', $permitType->has_renewal)" onchange="toggleRenewalSettings()" />
                        </div>

                        <div id="renewal-settings" style="{{ old('has_renewal', $permitType->has_renewal) ? '' : 'display: none;' }}">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="renewal_cycle_months" class="form-label">Renewal Cycle (Months)</label>
                                    <x-input type="number" name="renewal_cycle_months" placeholder="e.g., 24 for 2 years" value="{{ old('renewal_cycle_months', $permitType->renewal_cycle_months) }}" min="1" />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @php
                                        $reminderDays = old('reminder_days', $permitType->reminder_days ?? []);
                                    @endphp
                                    <div class="d-flex flex-wrap gap-3">
                                        <x-checkbox name="reminder_days[]" value="60" :checked="is_array($reminderDays) && in_array(60, $reminderDays)" label="60 Days Before" />
                                        <x-checkbox name="reminder_days[]" value="30" :checked="is_array($reminderDays) && in_array(30, $reminderDays)" label="30 Days Before" />
                                        <x-checkbox name="reminder_days[]" value="15" :checked="is_array($reminderDays) && in_array(15, $reminderDays)" label="15 Days Before" />
                                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="government_fee" id="government_fee" step="0.01" min="0" placeholder="0.00" value="{{ old('government_fee', $permitType->government_fee) }}">
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control" name="cls_service_fee" id="cls_service_fee" step="0.01" min="0" placeholder="0.00" value="{{ old('cls_service_fee', $permitType->cls_service_fee) }}">
                                </div>
                                <small class="text-muted">Automatically appears on invoice</small>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control" name="city_county_fee" id="city_county_fee" step="0.01" min="0" placeholder="0.00" value="{{ old('city_county_fee', $permitType->city_county_fee) }}">
                                </div>
                                <small class="text-muted">Automatically appears on invoice</small>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control" name="additional_fee" id="additional_fee" step="0.01" min="0" placeholder="0.00" value="{{ old('additional_fee', $permitType->additional_fee) }}">
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <x-input name="additional_fee_description" placeholder="Describe the additional fee (optional)" value="{{ old('additional_fee_description', $permitType->additional_fee_description) }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <div id="sub-permits-container">
                            <!-- Existing sub-permits will be loaded here -->
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Load existing sub-permits
    @foreach($permitType->subPermits as $subPermit)
        addSubPermit('{{ $subPermit->id }}', '{{ addslashes($subPermit->name) }}', {{ $subPermit->is_active ? 'true' : 'false' }});
    @endforeach
});
...
function addSubPermit(id = '', name = '', isActive = true) {
        ...
        <div class="card mb-2" id="sub-permit-${index}">
            <div class="card-body py-2 px-3">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <input type="hidden" name="sub_permits[${index}][id]" value="${id}">
