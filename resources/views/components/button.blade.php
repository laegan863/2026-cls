...
@php
    $variantClass = match($variant) {
        ...
        'light' => 'btn-light-custom',
        'dark' => 'btn-dark-custom',
        'secondary' => 'btn-secondary-custom',
        'outline-success' => 'btn-outline-success-custom',
        'outline-danger' => 'btn-outline-danger-custom',
        'outline-warning' => 'btn-outline-warning-custom',
        'outline-info' => 'btn-outline-info-custom',
        'outline-secondary' => 'btn-outline-secondary-custom',
        'link' => 'btn-link',
        default => 'btn-' . $variant,
    };
